...
const (
	EmojiClass                 Class = 0
	Emoji_ComponentClass       Class = 1
	Emoji_ModifierClass        Class = 2
	Emoji_Modifier_BaseClass   Class = 3
	Emoji_PresentationClass    Class = 4
	Extended_PictographicClass Class = 5
...
func (c Class) String() string {
	...
	case EmojiClass:
		return "EmojiClass"
	case Emoji_ComponentClass:
		return "Emoji_ComponentClass"
	case Emoji_ModifierClass:
		return "Emoji_ModifierClass"
	case Emoji_Modifier_BaseClass:
		return "Emoji_Modifier_BaseClass"
	case Emoji_PresentationClass:
		return "Emoji_PresentationClass"
	case Extended_PictographicClass:
		return "Extended_PictographicClass"
	}
}

var rangeFromClass = []*unicode.RangeTable{
	EmojiClass:                 Emoji,
	Emoji_ComponentClass:       Emoji_Component,
	Emoji_ModifierClass:        Emoji_Modifier,
	Emoji_Modifier_BaseClass:   Emoji_Modifier_Base,
	Emoji_PresentationClass:    Emoji_Presentation,
